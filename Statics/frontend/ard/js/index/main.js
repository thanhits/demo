(function($) {
  $(function() {
    ...
    //   if($(window).width() >= 768)
    //   {
    //     var x1 = $(window).scrollTop() + $(window).height(), x2 = $('.additional-services').offset().top;
    //     $('.additional-services').css('background-position', 'center ' + parseInt((x1 - x2)/($(window).height()/50)) + '%');

    //     $('.additional-services').find('.left').css('height' , $('.additional-services').find('.right').outerHeight());
    //   }
    // });
